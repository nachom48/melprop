...
const NavbarNextUI: React.FC = () => {
    const { user, isLoggedIn, logout } = useUser();
    const [isLoginOpen, setIsLoginOpen] = useState(false);

    const getDisplayName = () => {
        const nameCandidate = (user as any)?.fullName || (user as any)?.full_name || (user as any)?.name || (user as any)?.username || (user as any)?.email || 'Usuario';
        if (typeof nameCandidate === 'string') {
            // Si es un email, tomar lo anterior a @
            const base = nameCandidate.includes('@') ? nameCandidate.split('@')[0] : nameCandidate;
            return base.split(' ')[0];
        }
        return 'Usuario';
    };
        ...
        <header className="border-border-header flex items-center border-b bg-white">
            <div className="container flex items-center gap-8">
                ...
                <ul className="nav">
                                                    ...
                                                    <ul className="menu-col">
                                                        ...
                                                        <li className="flex gap-2">
                                                            <div className="flex items-center gap-1">
                                                                <input type="radio" id="dolares" name="currency" />
                                                                <label htmlFor="dolares">Dólares</label>
                                                            </div>
                                                            <div className="flex items-center gap-1">
                                                                <input type="radio" id="pesos" name="currency" />
                                                        ...
                                                        <li>
                                                            <div className="wrapper-input flex flex-col gap-1">
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    placeholder="USD"
                                                                    className="!border-input-border max-w-[180px] !border-1 placeholder:font-normal"
                                                                />
                                                            </div>
                                                        </li>
                                                        <li>
                                            ...
                                            <div className="mx-auto max-w-[1026px] px-6">
                                                <div className="flex flex-col gap-4 lg:flex-row">
                                                    ...
                                                    <ul className="menu-col">
                                                        ...
                                                        <li className="flex gap-2">
                                                            <div className="flex items-center gap-1">
                                                                <input type="radio" id="alqdolares" name="currency-alquiler" />
                                                                <label htmlFor="alqdolares">Dólares</label>
                                                            </div>
                                                            <div className="flex items-center gap-1">
                                                                <input type="radio" id="alqpesos" name="currency-alquiler" />
                    ...
                    <li className="flex flex-col items-center justify-center">
                        <Link to="/exclusive">Mel exclusive</Link>
                    </li>
                    <li className="flex flex-col items-center justify-center">
                    ...
                    >
                        ...
                        {hoveredItem === 'somos' && (
                            <div
                                className="wrapper-sub-menu-small"
                                onMouseEnter={() => handleMouseEnter('somos')}
                                onMouseLeave={handleMouseLeave}
                            >
                        ...
                        {hoveredItem === 'servicios' && (
                            ...
                            >
                                <ul className="sub-menu">
                                    ...
                                    <li>
                                        <Link to="/venta-alquiler">Ventas & Alquileres</Link>
                                    </li>
                                    <li>
                                        <Link to="/adm-alquileres">Adm. de alquileres</Link>
                                    </li>
                                    <li>
                                        <Link to="/asesoramiento-juridico">As. Jurídico</Link>
                                    </li>
                                </ul>
                            </div>
                        )}
                    ...
                    >
                        {isLoggedIn ? (
                            <>
                                <span>
                                    Hola {getDisplayName()} <i className={`fa-solid ${hoveredItem === 'user' ? 'fa-chevron-up' : 'fa-chevron-down'}`}></i>
                                </span>
                                {hoveredItem === 'user' && (
                                    <div className="wrapper-sub-menu-small">
                                        <ul className="sub-menu">
                                            <li>
                                                <Link to="/perfil">Mi cuenta</Link>
                                            </li>
                                            <li>
                                                <Link to="/perfil/cambio_contrasena">Cambiar contraseña</Link>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <Link to="/perfil/busquedas_guardadas">Búsquedas guardadas</Link>
                                            </li>
                                            <li>
                            ...
                            <>
                                <button className="btn" onClick={() => setIsLoginOpen(true)}>Iniciar sesión</button>
                                <LoginModal isShown={isLoginOpen} onClose={() => setIsLoginOpen(false)} />
                            </>
                        )}
                    </li>
                </ul>
